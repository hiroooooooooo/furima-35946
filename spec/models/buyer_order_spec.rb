...
RSpec.describe BuyerOrder, type: :model do
  describe '商品購入機能' do
    before do
      ...
      # @buyer_order = FactoryBot.build(:buyer_order, user_id: user.id, item_id: item.user_id)
      # @buyer_order = FactoryBot.build(:buyer_order, user_id: user.id, item_id: user.user_id.id)
      # @buyer_order = FactoryBot.build(:buyer_order, user_id: user.id, item_id: buyer.item_id)
      @buyer_order = FactoryBot.build(:buyer_order, user_id: user.id, item_id: user.id)
    end
